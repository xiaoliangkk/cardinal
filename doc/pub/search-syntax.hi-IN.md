...
- केस संवेदनशीलता UI टॉगल से नियंत्रित होती है:
  - नाम/पथ मिलान इस टॉगल का सीधे उपयोग करता है।
  - `content:` यही सेटिंग Spotlight को भेजता है।
...
`content:` macOS Spotlight कंटेंट इंडेक्स में **सादा सब‑स्ट्रिंग** खोजता है:

- `content:` के अंदर regex नहीं है; वैल्यू Spotlight को टेक्स्ट कंटेंट के रूप में भेजी जाती है।
- केस संवेदनशीलता Spotlight query modifier के ज़रिए UI टॉगल का पालन करती है।
- बहुत छोटी सुइयाँ अनुमत हैं, लेकिन `""` (खाली) अस्वीकृत है।
- `*`, `'` या `\` वाले मान अस्वीकृत हैं, क्योंकि ये वर्ण Spotlight query syntax को प्रभावित करते हैं।
- परिणाम Spotlight indexing और उन file types पर निर्भर करते हैं जिनसे Spotlight टेक्स्ट निकाल सकता है।
...
कंटेंट मिलान फ़ाइल बॉडी को सीधे नहीं पढ़ता; यह केवल Spotlight का उपयोग करता है।
